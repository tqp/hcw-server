...
public class HistoryDao {
    ...
    public List<History> getHistoryListByStudentId(Integer studentId) {
        ...
        query.append("          Rel_Student_Program_Status.student_program_status_id AS association_id,\n");
        ...
        query.append("          start_date,\n");
        query.append("          Rel_Student_Caregiver.student_caregiver_id AS association_id,\n");
        ...
        query.append("          start_date,\n");
        query.append("          Rel_Student_Case_Manager.student_case_manager_id AS association_id,\n");
        ...
        query.append("          start_date,\n");
        query.append("          Rel_Student_Sponsor.student_sponsor_id AS association_id,\n");
        ...
        try {
            return this.mySqlAuthJdbcTemplate.query(query.toString(), new Object[]{studentId, studentId}, (rs, rowNum) -> {
                History row = new History();
                row.setHistoryTypeId(rs.getInt("history_type_id"));
                row.setHistoryTypeName(rs.getString("history_type_name"));
                row.setDeletedStatus(rs.getInt("deleted_status"));
                row.setStartDate(rs.getString("start_date"));
                row.setEntityId(rs.getInt("entity_id"));
                row.setHistoryDescription(rs.getString("history_description"));
                return row;
            });

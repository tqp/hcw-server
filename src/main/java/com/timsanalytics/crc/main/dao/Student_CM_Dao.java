...
@Service
public class Student_CM_Dao {
    private final Logger logger = LoggerFactory.getLogger(getClass().getName());
    private final JdbcTemplate mySqlAuthJdbcTemplate;
    private final UtilsDao utilsDao;

    @Autowired
    public Student_CM_Dao(JdbcTemplate mySqlAuthJdbcTemplate, UtilsDao utilsDao) {
    ...
    public List<Student> getStudentList_SSP(ServerSidePaginationRequest<Student> serverSidePaginationRequest, Integer userId) {
    ...
    private String getStudentList_SSP_RootQuery(ServerSidePaginationRequest<Student> serverSidePaginationRequest) {
        ...
        query.append("                              Rel_Student_Caregiver.start_date = effectiveDateComparison_cg.start_date\n");
        query.append("                              AND\n");
        query.append("                              Rel_Student_Caregiver.student_id > effectiveDateComparison_cg.student_id\n");
        query.append("                          )\n");
        query.append("                      )\n");
        query.append("                  )\n");
        ...
        query.append("                  AND Rel_Student_Case_Manager.case_manager_id = ?\n");
        query.append("                  AND ");
    ...
    public int getStudentList_SSP_TotalRecords(ServerSidePaginationRequest<Student> serverSidePaginationRequest, Integer userId) {
        StringBuilder query = new StringBuilder();
        query.append("          SELECT\n");
        query.append("              COUNT(*)\n");
        query.append("          FROM\n");
        ...
        query.append("          -- END ROOT QUERY\n");
        try {
            Integer count = this.mySqlAuthJdbcTemplate.queryForObject(query.toString(), new Object[]{userId}, Integer.class);

...
import com.timsanalytics.crc.main.services.events.PostGradEventService;
...
public class PostGradEventController {
    ...
    @Operation(summary = "Get Post-Grad Event List by Student ID", description = "Get Post-Grad Event List by Student ID", tags = {"Csi"}, security = @SecurityRequirement(name = "bearerAuth"))

...
public class CaseManager {
    private String caseManagerGuid;
    ...
    public String getCaseManagerGuid() {
        return caseManagerGuid;
    }

    public void setCaseManagerGuid(String caseManagerGuid) {
        this.caseManagerGuid = caseManagerGuid;
    }
